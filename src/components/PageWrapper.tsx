    ...
    <div className="space-y-6 animate-fade-in">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-[#111827] border border-[#1F2937] rounded-2xl p-5 shadow-[0_1px_3px_rgba(0,0,0,0.2)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-[#111827] border border-[#1F2937] rounded-2xl p-5 shadow-[0_1px_3px_rgba(0,0,0,0.2)]">
          <div className="h-5 skeleton rounded w-36 mb-4" />
          <div className="h-[300px] skeleton rounded" />
        </div>
        <div className="bg-[#111827] border border-[#1F2937] rounded-2xl p-5 shadow-[0_1px_3px_rgba(0,0,0,0.2)]">
          <div className="h-5 skeleton rounded w-36 mb-4" />
          <div className="h-[300px] skeleton rounded" />
        </div>
      </div>
