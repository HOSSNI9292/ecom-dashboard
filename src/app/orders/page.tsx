...
import { formatCurrency, formatDate, getImageUrl, filterOrdersByDate } from "@/utils";
      ...
      render: (o: Order) => (
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-[#1F1F1F] flex items-center justify-center shrink-0 overflow-hidden">
            {o.productImage ? (
              <img src={getImageUrl(o.productImage)} alt={o.productName} className="w-full h-full object-cover" loading="lazy" />
            ) : (
